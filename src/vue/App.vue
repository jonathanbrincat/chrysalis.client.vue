    ...
    <div class="container">
      <nav class="navbar navbar-expand-md navbar-light">
        <div class="navbar-header">
          ...
          <div id="app__navigation" class="collapse navbar-collapse justify-content-between">
            <ul class="ui__navigation navigation__primary navbar-nav">
              <li><router-link to="/posts">Listings</router-link></li>
            </ul>
          </div>
        </div>
      </nav>
